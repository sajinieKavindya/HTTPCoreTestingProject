...
public class ClosesConnectionBeforeReceivingResponseHTTPS {
    ...
    public static void main(String[] args) {
        ...
        ClosesConnectionBeforeReceivingResponseHTTPS client = new ClosesConnectionBeforeReceivingResponseHTTPS();
//        for (int i = 0; i < 1000; i++) {
        client.run();
//        }
    }

    ClosesConnectionBeforeReceivingResponseHTTPS() {

    }

    ClosesConnectionBeforeReceivingResponseHTTPS(String host, int port) {
    ...
    static class ClientThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                // close the socket once request is written
                sslSocket.close();
                System.exit(-1);
                String line = null;
                int i = 0;

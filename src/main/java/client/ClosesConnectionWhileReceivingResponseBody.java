...
public class ClosesConnectionWhileReceivingResponseBody {
    ...
    public static void main(String[] args) {
        ...
        ClosesConnectionWhileReceivingResponseBody client = new ClosesConnectionWhileReceivingResponseBody();
        client.run();
    }

    ClosesConnectionWhileReceivingResponseBody() {

    }

    ClosesConnectionWhileReceivingResponseBody(String host, int port) {
    ...
    public void run() {
        ...
        try {
            ...
            new ClosesConnectionWhileReceivingResponseBody.ClientThread(socket).start();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    static class ClientThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                printWriter.print("GET /test HTTP/1.1\r\n");

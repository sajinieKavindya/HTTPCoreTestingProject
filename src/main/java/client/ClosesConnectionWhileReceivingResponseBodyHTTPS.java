...
public class ClosesConnectionWhileReceivingResponseBodyHTTPS {
    ...
    public static void main(String[] args) {
        ...
        ClosesConnectionWhileReceivingResponseBodyHTTPS client = new ClosesConnectionWhileReceivingResponseBodyHTTPS();
        for (int i = 0; i < 1000; i++) {
            client.run();
        }
    }

    ClosesConnectionWhileReceivingResponseBodyHTTPS() {

    }

    ClosesConnectionWhileReceivingResponseBodyHTTPS(String host, int port) {

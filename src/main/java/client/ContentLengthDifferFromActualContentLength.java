...
public class ContentLengthDifferFromActualContentLength {
...
//        }
    ...
    ContentLengthDifferFromActualContentLength(String host, int port) {
    ...
    static class ClientThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                printWriter.print("Content-Length: 500" + "\r\n");

...
public class ContentTypeAndBodyMismatchHTTPS {
    ...
    public static void main(String[] args) {
        ...
        ContentTypeAndBodyMismatchHTTPS client = new ContentTypeAndBodyMismatchHTTPS();
//        for (int i = 0; i < 1000; i++) {
        client.run();
//        }
    }

    ContentTypeAndBodyMismatchHTTPS() {

    }

    ContentTypeAndBodyMismatchHTTPS(String host, int port) {
